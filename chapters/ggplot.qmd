...
[ggplot2](https://ggplot2.tidyverse.org/) (this is what people mean when they just say "ggplot") is a popular package for plotting data in R. It has been extended to work with spatial data. Like `tmap`, it also uses the concepts of a Grammar of Graphics to layer data as well as visualization rules.
...
We will focus on ggplot in this workshop.
