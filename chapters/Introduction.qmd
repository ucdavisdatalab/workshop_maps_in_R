...
```{r chunk-libraries, eval=FALSE, echo = TRUE}
	# load libraries
...
```{r chunk-loaddata, eval=TRUE, echo = TRUE}
	# read spatial data
	
	monsters <- read_sf("data/LakeMonsters.gpkg", layername="LakeMonsters")
	lakes <- read_sf("data/Lakes_GreatLakes-Area.gpkg", layername="Lakes_GreatLakes-Area")
	states <- read_sf("data/US_CAN_Admin1.gpkg", layername="US_CAN_Admin1")
)
```
